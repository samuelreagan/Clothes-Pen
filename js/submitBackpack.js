...
var updateObject = JSON.parse(localStorage.getItem('backpackStorage'));
//var totalVolunteersNeeded = 10;
//var totalVolunteers = 5;
...
function submit() {
  ...
  localStorage.setItem("backpackStorage", JSON.stringify(updateObject));
}
